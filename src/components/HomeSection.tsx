        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="flex justify-center mb-8">
              <img src="https://cdn.poehali.dev/projects/5dffc7a2-bb39-4eec-ad6e-6308d2b14ecb/files/eaf6a138-eee2-413b-a158-2bd94f235cbb.jpg" alt="КЛ - Качество и Любовь" className="h-48 w-auto animate-float hover-scale" />
            </div>
