      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 animate-fade-in">
            <img src="https://cdn.poehali.dev/projects/5dffc7a2-bb39-4eec-ad6e-6308d2b14ecb/files/04d692cb-44ad-49b1-9c7b-3c622a7f1c20.jpg" alt="КЛ" className="h-14 w-auto hover-scale object-contain logo-colorful" />
          </div>
