      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 animate-fade-in">
            <img src="https://cdn.poehali.dev/projects/5dffc7a2-bb39-4eec-ad6e-6308d2b14ecb/files/d11fb031-323a-48e8-a9dc-ab941b4f78f8.jpg" alt="КЛ" className="h-14 w-auto hover-scale object-contain logo-colorful" />
          </div>
